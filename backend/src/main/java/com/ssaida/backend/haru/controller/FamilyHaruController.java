...
public class FamilyHaruController {
    ...
    public ResponseEntity<List> getMonthlyHaru(@Parameter(description = "가족 ID") @PathVariable("family_id") int familyId,
    ...
    public ResponseEntity<List> getRecords(@Parameter(description = "가족 ID") @PathVariable("family_id") int familyId,
